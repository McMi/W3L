...
public class TerminplanerUI {
    ...
    public static void main(String args[]) {
        ...
        TerminplanerUI.hinzufuegenTermin(new Termin(LocalDate.of(2016, 12, 24), "Michael Lintl"));
            ...
            try {
                ...
                switch (wahl) {
                    case 1:
                        ...
                        TerminplanerUI.hinzufuegenTermin(new Termin(datum, beschreibung));
                        TerminplanerUI.sortiereTerminplaner();
                        System.out.println("Termin wurde angelegt.");
                        break;
                    case 2:
                        System.out.println("Vorhandene Termine:");
                        TerminplanerUI.anzeigenTerminplaner();
                        break;
                    case 3:
                        ende = true;
     ...
     */
    private static void anzeigenTerminplaner() {
